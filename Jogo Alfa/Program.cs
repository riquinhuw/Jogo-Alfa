...
namespace Jogo_Alfa
{
    ...
    { 
       ...
       // public static bool loopingCidade = true;
        public static Protagonista protagonista1 = new Protagonista("nomes",0,0,0,false,0,0,0,7,2,1,0,"norte",2); //Criação do protagonista
        static void Main()
        ...
        {          
            ...
            if (resposta == 's')
            {
                ...
                resposta = char.Parse(Console.ReadLine());
                if (resposta == 's') { Console.Clear(); resposta = 'n'; Capitulo1.Cidade(); }else { Capitulo1.Cidade(); }
